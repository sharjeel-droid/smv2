                ...
                Form(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      //
                      // )
                      defaults.widget.inputTexts.simple(key:"",
                          initialValue:_viewModel.userName.value,
                          hint: "username",
                          onError: (value)=> (value==null||value.isEmpty) ? 'username cannot be empty' : null,
                          onSaved: (value)=> {
                            _viewModel.handleUserNameChanges(value)
                          }
                      ),

                      Padding(padding: EdgeInsets.only(top: defaults.dimens.padding.def), child:
                      defaults.widget.inputTexts.simple(key:"",
                          initialValue:_viewModel.password.value,
                          hint: "password",
                          isHiddenField: true,
                          onError: (value)=> (value==null||value.isEmpty) ? 'password cannot be empty' : null,
                          onSaved: (value)=> {
                            // _email=value!
                      ...
                      Padding(padding: EdgeInsets.only(top: defaults.dimens.padding.def),
                          child:
                              Obx(() =>
                                  Row(mainAxisSize: MainAxisSize.max,
                                    ...
                                    children: [
                                      ...
                                      _viewModel.isProcessing.value?defaults.widget.circularProgIndicator():Spacer(flex: 1,),

                                      Spacer(flex: 1,),
                                      defaults.widget.clickables.text.simple(labelText: "forgot your password?",onPressed: (){
                      ...
                      Padding(padding: EdgeInsets.only(top: defaults.dimens.padding.def),
                          child:
                          defaults.widget.clickables.buttons.def(labelText: "login",
                      ...
                      Padding(padding: EdgeInsets.only(top: defaults.dimens.padding.def),
                          ...
                          Row(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              Flexible(flex: 1,child: Divider(thickness:1, color: Color(defaults.colors.argb.grey),)),
                              Padding(padding: EdgeInsets.only(left: defaults.dimens.padding.def, right: defaults.dimens.padding.def), child: defaults.widget.label.simple(labelText: "OR"),),
                              Flexible(flex:1, child: Divider(thickness: 1, color: Color(defaults.colors.argb.grey),))
                            ],)
                      ...
                      Padding(padding: EdgeInsets.only(top: defaults.dimens.padding.def),
                          child:
                          defaults.widget.clickables.buttons.dark(labelText: "sign up",
                              // endIcon: Icons.arrow_forward,
                              onPressed: (){
                                dev.log("clicked");
                              })
